...
class Settings(models.Model):
    ...
    sensor_left = models.ForeignKey(Sensor, on_delete=models.CASCADE, verbose_name="Первый датчик по центру", related_name='center_left', null=True, blank=True)
    sensor_right = models.ForeignKey(Sensor, on_delete=models.CASCADE, verbose_name="Второй датчик по центру", related_name='center_right', null=True, blank=True)

...
class Settings(models.Model):
    ...
    hsv_black = models.ForeignKey(HsvObject, on_delete=models.CASCADE, verbose_name="HSV черного", related_name='hsv_black', null=True, blank=True)
    hsv_white = models.ForeignKey(HsvObject, on_delete=models.CASCADE, verbose_name="HSV белого", related_name='hsv_white',  null=True, blank=True)

...
class Settings(models.Model):
    ...
    sensor_left = models.ForeignKey(Sensor, on_delete=models.CASCADE, verbose_name="Первый датчик по центру", related_name='center_left')
    sensor_right = models.ForeignKey(Sensor, on_delete=models.CASCADE, verbose_name="Второй датчик по центру", related_name='center_right')
